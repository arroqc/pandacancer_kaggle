...
image_folder = os.path.join(data_dir, 'H:/train_tiles_224_2_10/')
...
class PANDADataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img_id = row.image_id
        tiles = [image_folder + '0/' + img_id + '_' + str(i) + self.suffix + '.png' for i in range(0, self.n_tiles)]
...
if __name__=='__main__':
    ...
    def val_epoch(loader, get_output=False):
        ...
        qwk_r = cohen_kappa_score(PREDS[df_valid['data_provider'] == 'radboud'],
                                  df_valid[df_valid['data_provider'] == 'radboud'].isup_grade.values, weights='quadratic')
